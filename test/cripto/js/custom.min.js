function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), console.log("OLA"), $BODY.toggleClass("nav-md nav-sm"), a()
...
$.fn.popover.Constructor.prototype.leave = function (a) {
    ...
    init_sparklines(), init_flot_chart(), /*init_sidebar(),*/ init_wysiwyg(), init_InputMask(), init_JQVmap(), init_cropper(), init_knob(), init_IonRangeSlider(), init_ColorPicker(), init_TagsInput(), init_parsley(), init_SmartWizard(), init_EasyPieChart(), /*init_charts(), */init_echarts(), init_morris_charts(), init_skycons(), init_select2(), init_validator(), init_DataTables(), init_chart_doughnut(), init_gauge(), init_PNotify(), init_starrr(), init_calendar(), init_compose(), init_CustomNotification(), init_autosize(), init_autocomplete(), init_menu()
});